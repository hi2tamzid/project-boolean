  ...
  <div class="row">
    <div class="col-md-6">
      <div class="input-group mb-3">
        ...
        <input name="student_id" value="{{ old('student_id') }}" type="text" class="form-control" placeholder="Enter student id" aria-label="register_student_id" aria-describedby="register_student_id" required>
      </div>
